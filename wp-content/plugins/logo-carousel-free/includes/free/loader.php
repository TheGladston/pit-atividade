				...
				<div class="sp-lc__count-area">
					...
					<div class="count-item">
						...
						if ( isset( $plugin_data['plugins'] ) ) {
							...
							echo esc_attr( $plugin_downloads['http://wordpress.org/plugins/logo-carousel-free'] );
						} else {
							echo '305000';
						}
						?>
					...
					<div class="count-item">
						...
						if ( isset( $plugin_data['plugins'] ) ) {
							...
							echo esc_attr( $plugin_rating['http://wordpress.org/plugins/logo-carousel-free'] ) . '/5';
						} else {
							echo '4.7/5';
						}
						?>
