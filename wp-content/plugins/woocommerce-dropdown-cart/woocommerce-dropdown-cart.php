...
class WooCommerce_Widget_DropdownCart extends WP_Widget
{
    ...
    function widget($args, $instance)
    {
        ...
        $minha_conta = __('My account', 'almada');
        ?>
            ...
            <?php if (!$hide_if_empty || $cart_contents_count > 0) : ?>
                <div class="dropdown-cart-button <?php echo $hide_if_empty ? 'hide_dropdown_cart_widget_if_empty' : '' ?>" style="<?php echo $hide_if_empty && sizeof($woocommerce->cart->get_cart()) == 0 ? "display:none;" : "" ?>">
                    <a href="#" class="dropdown-total">
                        <?php //echo '<span>'. $minha_conta .'</span>'; 
                                    ?>
                        <?php echo '<i class="fa fa-shopping-cart" aria-hidden="true"></i>
'; ?>
                        <?php echo '<span class="count">' . $cart_contents_count . '</span>'; ?>
                        <?php // echo $cart_contents_count . ' ' . _n($item_text, $items_text, $cart_contents_count) 
                                    ?>
