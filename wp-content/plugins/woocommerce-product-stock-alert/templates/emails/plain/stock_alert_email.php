...
echo sprintf( __( "Hi there. You have subscribed a product. Your subscribed product is available now. Product details are shown below for your reference:", 'woocommerce-product-stock-alert' ) ) . "\n\n";
